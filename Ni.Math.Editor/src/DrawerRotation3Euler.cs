...
{
    [CustomPropertyDrawer(typeof(Rotation3Euler))]
    public class DrawerRotation3Euler : NiMathDrawer
    {
        ...
        {
            var propRotation = CreateSubPropertyField(property, "rotation");
            root.Add(propRotation);
        }
        ...
        public class Gizmo : NiMathEditorGUI.IGizmo
        {
            ...
            {
                var o = PropertySerialization.PropertyToRotationEulerTransform3(property);
    ...
    {
        public static void Draw(Rotation3Euler o)
        {
        ...
        public static void Draw(Rotation3Euler o, Transform transform)
        {
