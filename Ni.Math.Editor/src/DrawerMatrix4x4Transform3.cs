...
{
    [CustomPropertyDrawer(typeof(Matrix4x4Transform3))]
    public class DrawerMatrix4x4Transform3 : NiMathDrawer
    {
        ...
        public class Gizmo : NiMathEditorGUI.IGizmo
        {
            ...
            {
                var o = PropertySerialization.PropertyToMatrix4x4Transform3(property);
    ...
    {
        public static void Draw(Matrix4x4Transform3 o)
        {
        ...
        public static void Draw(Matrix4x4Transform3 o, Transform transform)
        {
