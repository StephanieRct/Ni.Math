...
{
    [CustomPropertyDrawer(typeof(UniformTransform3))]
    public class DrawerUniformTransform3 : NiMathDrawer
    {
        ...
        public class Gizmo : NiMathEditorGUI.IGizmo
        {
            ...
            {
                var o = PropertySerialization.PropertyToUniformTransform3(property);
    ...
    {
        public static void Draw(UniformTransform3 o)
        {
        ...
        public static void Draw(UniformTransform3 o, Transform transform)
        {
